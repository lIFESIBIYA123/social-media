...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", 
    default='django-insecure-%##aecv2(=lj8$^4jnhr7kzzfku68o#nnv@@q(ib9l$8q2_a=p'
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False if ENV == "PROD" else True

ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", default="54.82.138.3,localhost,127.0.0.1,*").split(",")
...
INSTALLED_APPS = [
    ...
    # core app and external packages
    'rest_framework',
