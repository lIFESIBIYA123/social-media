      ...
      <Card.Body>
        <Card.Title className="d-flex flex-row justify-content-between">
          <div className="d-flex flex-row">
            ...
            />
            <div className="d-flex flex-row justify-content-start align-self-center mt-2 gap-2">
              <p className="fs-6 small m-0">{comment.author.first_name}</p>
              <p className="fs-6 small m-0">{comment.author.last_name}</p>
